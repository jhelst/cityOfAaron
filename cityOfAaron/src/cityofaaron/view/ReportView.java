...
/**
 * The MainMenuView class - part of the view layer Object of this class manages
 * the main menu
 *
 * @author carolmadella
 */
public class ReportView extends MenuView {
    ...
    /**
     * The MainMenuView constructor Purpose: Initialize the menu data
    ...
    /**
     * The doAction method Purpose: performs the selected action Parameters:
     * none Returns: none
     */
    @Override
    ...
    /**
     * The listTools method Purpose: list all the tools saved. Parameters: none
     * Returns: none Ramon Andrade
     *
     * @throws IOException
     */
